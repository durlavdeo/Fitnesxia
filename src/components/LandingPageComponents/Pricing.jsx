...
const PricingSection = () => {
  ...
  return (
    <SectionLayout
        id={"pricing"}
      className={"bg-primary-100 flex flex-col items-center gap-6 text-white py-20 "}
    >
          ...
          <div className="mt-8 flex items-center gap-8">
            {
                pricings.map((pricing,index) => (
                    <PricingCard key={index} title={pricing.title} price={pricing.price} isPopular={pricing.isPopular} featureLimit={pricing.featureLimit} />
                ))
            }
          </div>
