...
const Programs = () => {
  return (
    <SectionLayout
      id={"programs"}
      className={"bg-primary-100 text-white py-20"}
    >
      <Helmet>
        <title>
          Explore Our Fitness Programs: Tailored Workout Plans & Online Coaching
        </title>
        <meta
          name="description"
          content="Discover a variety of fitness programs for all fitness levels, including home workouts, personalized training plans, and online coaching. Whether you're a beginner or expert, our fitness services help you achieve your goals. Start today!"
        />
      </Helmet>
      <div className="flex justify-between items-center">
        <h1 className="text-4xl capitalize font-bold max-w-[450px]">
          the best programs we offers for you
        </h1>
        <p className="max-w-[480px] text-sm text-gray-300">
          ...
          achieve goals and maximize results.{" "}
        </p>
      </div>
